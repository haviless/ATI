object FCabeceraIngreso: TFCabeceraIngreso
  Left = 255
  Top = 95
  Align = alCustom
  ...
  object dbgCabeceraIngreso: TwwDBGrid
    ...
    TitleLines = 1
    TitleButtons = True
    OnCalcCellColors = dbgCabeceraIngresoCalcCellColors
    OnTitleButtonClick = dbgCabeceraIngresoTitleButtonClick
    OnDblClick = dbgCabeceraIngresoDblClick
    OnKeyDown = dbgCabeceraIngresoKeyDown
